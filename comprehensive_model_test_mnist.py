...
"""
Comprehensive test of generate_triggered_dataset function across 50 MNIST models.
This script validates that the function works robustly across different:
- Architectures (Model_Google_1, Model_Google_3, etc.)  
...
def run_comprehensive_test_mnist(num_models=50, ba_threshold=5.0, asr_threshold=5.0):
    """
    Run comprehensive test across multiple MNIST models
    ...
    print("="*80)
    print("COMPREHENSIVE MNIST MODEL TEST")
    print("="*80)
    ...
    results_file = f"test_results/comprehensive_test_mnist_results_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
...
if __name__ == "__main__":
    ...
    print("🚀 Starting comprehensive robustness test for MNIST models...")
    print("This may take 30-60 minutes depending on hardware...")
    
    start_time = time.time()
    results = run_comprehensive_test_mnist(num_models=50, ba_threshold=5.0, asr_threshold=5.0)
    end_time = time.time()
